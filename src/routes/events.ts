...
function canReadEventForScope(
  user: { role: RoleName; clinicId: string | null; facilityId: string | null },
  payload: unknown
) {
...
export async function registerEventRoutes(app: FastifyInstance) {
  app.get(
    "/events/outbox",
    { preHandler: requireRoles(RoleName.Admin, RoleName.RevenueCycle) },
    async (request) => {
