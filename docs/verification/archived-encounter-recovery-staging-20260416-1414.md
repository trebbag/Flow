...
- [src/routes/encounters.ts](../../src/routes/encounters.ts)
- [src/lib/room-operations.ts](../../src/lib/room-operations.ts)
- [tests/backend.spec.ts](../../tests/backend.spec.ts)
- [admin-console.tsx](../Flow%20Frontend/src/app/components/admin-console.tsx)
- [api-client.ts](../Flow%20Frontend/src/app/components/api-client.ts)
- [encounter-context.tsx](../Flow%20Frontend/src/app/components/encounter-context.tsx)
- [encounter-detail-view.tsx](../Flow%20Frontend/src/app/components/encounter-detail-view.tsx)
- [types.ts](../Flow%20Frontend/src/app/components/types.ts)
- [package.json](../Flow%20Frontend/package.json)
- [pnpm-lock.yaml](../Flow%20Frontend/pnpm-lock.yaml)
- [vite.config.ts](../Flow%20Frontend/vite.config.ts)
